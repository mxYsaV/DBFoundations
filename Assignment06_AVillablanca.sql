--*************************************************************************--
-- Title: Assignment06
-- Author: Alyssa Villablanca
-- Desc: This file demonstrates how to use Views
-- Change Log: When,Who,What
-- 2024-21-05,AVillablanca,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_AVillablanca')
	 Begin 
	  Alter Database [Assignment06DB_AVillablanca] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_AVillablanca;
	 End
	Create Database Assignment06DB_AVillablanca;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_AVillablanca;
